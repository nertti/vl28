...
<header class="header header_transparent">
    <div class="header__left">
      <a href="#" data-hystmodal="#menuModal" class="menu-btn">
        ...
        <span class="menu-btn__text" title="Меню">Меню</span>
      </a>
      <a href="#" data-hystmodal="#searchModal" class="search-btn">
          ...
          <span class="search-btn__text" title="Поиск">Поиск</span>
        </a>
    </div>
    ...
    <a href="/profile/favorite/" class="header__link" title="Избранное">
    ...
    <a href="/profile/" class="header__link" title="Профиль">
    ...
    <a href="#" data-hystmodal="#cartModal" class="header__link header__cart" title="Корзина">
        <img src="<?=SITE_TEMPLATE_PATH?>/assets/img/cart.svg" alt="cart icon" class="header__link-icon header__link-icon_cart svg">
        <?php include $_SERVER['DOCUMENT_ROOT'] . '/include/header/basketLine.php'; ?>
    </a>
    </div>
  </header>
